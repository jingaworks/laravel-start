...
class SubcategoryApiController extends Controller
{
    public function index()
    {
        ...
        return new SubcategoryResource(Subcategory::with(['category', 'added_by', 'approved_by'])->get());
    }
    ...
    public function show(Subcategory $subcategory)
    {
        ...
        return new SubcategoryResource($subcategory->load(['category', 'added_by', 'approved_by']));
    }
