        ...
        <form method="POST" action="{{ route("admin.subcategories.update", [$subcategory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('approved') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="approved" id="approved" value="1" {{ $subcategory->approved || old('approved', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="approved">{{ trans('cruds.subcategory.fields.approved') }}</label>
                </div>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.subcategory.fields.approved_helper') }}</span>
            </div>
            <div class="form-group">
