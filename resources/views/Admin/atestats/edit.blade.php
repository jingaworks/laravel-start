    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.atestats.update", [$atestat->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number') ? 'is-invalid' : '' }}" type="number" name="number" id="number" value="{{ old('number', $atestat->number) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('valid_year') ? 'is-invalid' : '' }}" type="text" name="valid_year" id="valid_year" value="{{ old('valid_year', $atestat->valid_year) }}" required>
