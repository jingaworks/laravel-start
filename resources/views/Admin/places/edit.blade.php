    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.places.update", [$place->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('denloc') ? 'is-invalid' : '' }}" type="text" name="denloc" id="denloc" value="{{ old('denloc', $place->denloc) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('codp') ? 'is-invalid' : '' }}" type="text" name="codp" id="codp" value="{{ old('codp', $place->codp) }}" required>
                @if($errors->has('codp'))
                    <div class="invalid-feedback">
                        {{ $errors->first('codp') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sirsup') ? 'is-invalid' : '' }}" type="text" name="sirsup" id="sirsup" value="{{ old('sirsup', $place->sirsup) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tip') ? 'is-invalid' : '' }}" type="number" name="tip" id="tip" value="{{ old('tip', $place->tip) }}" step="1" required>
                @if($errors->has('tip'))
                    <div class="invalid-feedback">
                        {{ $errors->first('tip') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zona') ? 'is-invalid' : '' }}" type="number" name="zona" id="zona" value="{{ old('zona', $place->zona) }}" step="1" required>
                @if($errors->has('zona'))
                    <div class="invalid-feedback">
                        {{ $errors->first('zona') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('niv') ? 'is-invalid' : '' }}" type="number" name="niv" id="niv" value="{{ old('niv', $place->niv) }}" step="1" required>
                @if($errors->has('niv'))
                    <div class="invalid-feedback">
                        {{ $errors->first('niv') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('med') ? 'is-invalid' : '' }}" type="number" name="med" id="med" value="{{ old('med', $place->med) }}" step="1" required>
                @if($errors->has('med'))
                    <div class="invalid-feedback">
                        {{ $errors->first('med') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('regiune') ? 'is-invalid' : '' }}" type="number" name="regiune" id="regiune" value="{{ old('regiune', $place->regiune) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fsj') ? 'is-invalid' : '' }}" type="number" name="fsj" id="fsj" value="{{ old('fsj', $place->fsj) }}" step="1">
                @if($errors->has('fsj'))
                    <div class="invalid-feedback">
                        {{ $errors->first('fsj') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fs_2') ? 'is-invalid' : '' }}" type="text" name="fs_2" id="fs_2" value="{{ old('fs_2', $place->fs_2) }}">
                @if($errors->has('fs_2'))
                    <div class="invalid-feedback">
                        {{ $errors->first('fs_2') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fs_3') ? 'is-invalid' : '' }}" type="text" name="fs_3" id="fs_3" value="{{ old('fs_3', $place->fs_3) }}">
                @if($errors->has('fs_3'))
                    <div class="invalid-feedback">
                        {{ $errors->first('fs_3') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fsl') ? 'is-invalid' : '' }}" type="number" name="fsl" id="fsl" value="{{ old('fsl', $place->fsl) }}" step="1">
                @if($errors->has('fsl'))
                    <div class="invalid-feedback">
                        {{ $errors->first('fsl') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rang') ? 'is-invalid' : '' }}" type="text" name="rang" id="rang" value="{{ old('rang', $place->rang) }}">
                @if($errors->has('rang'))
                    <div class="invalid-feedback">
                        {{ $errors->first('rang') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fictiv') ? 'is-invalid' : '' }}" type="text" name="fictiv" id="fictiv" value="{{ old('fictiv', $place->fictiv) }}">
