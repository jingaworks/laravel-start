            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-responsive table-borderless mb-0" v-if="tokens.length > 0">
                        ...
                        <tbody>
                            <tr v-for="(token, id) in tokens" :key="id">
                                <!-- Client Name -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-danger" v-if="form.errors.length > 0">
                            ...
                            <br>
                            <ul>
                                <li v-for="(error, id) in form.errors" :key="id">
                                    {{ error }}
                                </li>
                            </ul>
                        </div>
                        ...
                        <form role="form" @submit.prevent="store">
                            ...
                            <div class="form-group row" v-if="scopes.length > 0">
                                ...
                                <div class="col-md-6">
                                    <div v-for="(scope, id) in scopes" :key="id">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <textarea class="form-control" rows="10" v-model="accessToken" />
                    </div>
